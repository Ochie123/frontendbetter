...
import { useThisCategory } from '../../../../data'
//import Category from '../view/categories/Category';


const ProductCreateForm = ({ id, className, ...rest }) => {
  const { data = { results: [] }} = useQuery("results", loadCategories);
  
 
  const results = data.results;

  console.log(results)
  //const { category } = useThisCategory(id);
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    {results.map((result) => (
                      <option key={result.id} value={XPathResult.id}>
                        {result.name}
                      </option>
                    ))}
                  </TextField>
